...
class InvitationService:
    ...
    def _find_invitation(self, token: str, *, db: Session) -> UserInvitation | None:
        ...
        return db.execute(
            select(UserInvitation).where(UserInvitation.invite_token_hash == token_hash)
        ).scalar_one_or_none()

    def _get_invitation_validation_error(self, invitation: UserInvitation) -> str | None:
